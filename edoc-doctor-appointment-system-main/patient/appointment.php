...
<body>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            // Increment cancel_count in the patient table
            $timestamp = date('Y-m-d H:i:s'); // Current timestamp
            $database->query("UPDATE patient SET cancel_count = cancel_count + 1, last_cancel_timestamp = '$timestamp' WHERE pid = '$userid'");
            
            
                // If the cancel count is less than 2, allow the user to proceed with canceling the appointment
                $title = $_GET["title"];
                $docname = $_GET["doc"];
                // Display confirmation message and options to proceed with cancellation
