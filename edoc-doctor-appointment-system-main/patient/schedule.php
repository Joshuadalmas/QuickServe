 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $q='';
                $searchtype="All";
                $searchResultMessage = "We couldn't find anything related to your keywords!";
                // SQL query with keyword conditions for doctor name, title, scheduled date, and scheduled time
                // SQL query with keyword conditions for doctor name, title, scheduled date, and scheduled time
                $sqlmain = "SELECT * FROM schedule 
                INNER JOIN doctor ON schedule.docid = doctor.docid 
                WHERE schedule.scheduledate >= '$today' 
                AND CONCAT(schedule.scheduledate, ' ', schedule.scheduletime) >= '$currentTime' 
                AND (doctor.docname = '$keyword' 
                    ...
                    OR schedule.scheduledate LIKE '%$keyword' 
                    OR schedule.scheduledate LIKE '%$keyword%' 
                    OR schedule.scheduletime = '$keyword' 
                    OR schedule.scheduletime LIKE '$keyword%' 
                    OR schedule.scheduletime LIKE '%$keyword' 
                    OR schedule.scheduletime LIKE '%$keyword%')  
        ...
        // Update search result message based on query result
